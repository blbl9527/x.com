...
<div class="row">
    ...
    <div class="row">
        ...
        <form action="{{route('service.update',[$data['id']])}}" method="POST">
            ...
            <input type="text" name="c" value="c" hidden>
            <input type="submit" class="btn btn-danger" value="解除聘请">
       </form>
       <form action="{{url('/consumer')}}" method="GET">
          <input type="submit" class="btn btn-success" value="我再想想">
       </form>
       </div> 
